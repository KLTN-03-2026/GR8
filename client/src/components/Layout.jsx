...
const Layout = ({ children }) => {
  ...
  const getRoleBasedMenuItems = (role) => {
    const allItems = {
      ...
      services:          { key: "/services",         label: "Dịch vụ" },
      ...
      myAssets:          { key: "/my-assets",           label: "Tài sản căn hộ" },
      myServices:        { key: "/my-services",         label: "Dịch vụ" },
      transferRequests:  { key: "/transfer-requests",   label: "Chuyển nhượng" },
      myTransfers:       { key: "/my-transfers",        label: "Chuyển nhượng" },
    };
    ...
    const roleMenus = {
      ...
      NguoiThue: [
        ...
        allItems.myAssets, allItems.myServices, allItems.myTransfers,
      ],
      KhachVangLai: [
        allItems.home,
        allItems.browseApartments, allItems.myRentalRequests,
