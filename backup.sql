...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: userroles
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `userroles` (
  `NguoiDungID` int NOT NULL,
  `RoleID` int NOT NULL,
  PRIMARY KEY (`NguoiDungID`, `RoleID`),
  KEY `userroles_RoleID_idx` (`RoleID`),
  CONSTRAINT `userroles_NguoiDungID_fkey` FOREIGN KEY (`NguoiDungID`) REFERENCES `nguoidung` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: userroles
# ------------------------------------------------------------

INSERT INTO
  `userroles` (`NguoiDungID`, `RoleID`)
VALUES
  (2, 1);
INSERT INTO
  `userroles` (`NguoiDungID`, `RoleID`)
